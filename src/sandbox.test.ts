...
describe('content and unified map',()=>{
  it('ships the complete content catalog',()=>{expect(CROPS).toHaveLength(8);expect(FISH).toHaveLength(12);expect(FORAGE).toHaveLength(6);expect(RECIPES).toHaveLength(8);expect(Object.keys(SCENES)).toHaveLength(5)});
