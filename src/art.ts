...
export function iconSVG(kind:string,color='#d8b877'){
  const shapes:Record<string,string>={
    ...
    shell:'<path d="M5 19V12h4V8h14v4h4v10h-6v5H11v-5H5z" fill="#e7bcac"/><path d="M9 12v8h3V9h2v13h3V9h2v11h3v-8" stroke="#a97770" fill="none"/>',
    quartz:'<path d="M6 23V12l5-5 4 6 4-10 8 9v12l-10 5z" fill="#aacbd6"/><path d="m19 3 2 20-4 6-2-16z" fill="#edf0e5"/>',
